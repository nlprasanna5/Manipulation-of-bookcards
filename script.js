    ...
    },
    {
        ...
        website:
          "https://www.amazon.com/Git-Pocket-Guide-Working-Introduction/dp/1449325866",
             ...
             /*<div class="box">
                <div class="img">
                    <img src="http://speakingjs.com/speakingjs_cover.jpg" />
                </div>
                
                <h2>Speaking JavaScript</h2>
                <span>Axel Rauschmayer</span>
                <a href="http://speakingjs.com/" class="btn">Buy Now</a>
            </div> */
...
books.forEach((element) => {
    ...
    anchor.href=element.website;
    anchor.innerText="Buy Now";
    anchor.className="btn";

    div.append(div2,h2,span,anchor);
    col.append(div);
});